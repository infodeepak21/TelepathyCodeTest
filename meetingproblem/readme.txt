...
2 ways run the application:

Option-1

open the eclipse or any developments tool.
...
java -cp target\meetingproblem-0.0.1-SNAPSHOT.jar com.meeting.meetingproblem.RoomTest "Fully Qualified path for example-D:\telepathy\meetingproblem\meetings.txt"
